...
#define HSXPGCTL_REG		0x17A800
#define L2HSBPM_REG_SIZE	0x0008
#define L2HSBPM_REG(x) 		(HSXPGCTL_REG + L2HSBPM_REG_SIZE * (x))
#define HPSRAM_REGS(x) 		((volatile struct mtl_hpsram_regs* const)(HSXPGCTL_REG + 0x0008 * (x)))
