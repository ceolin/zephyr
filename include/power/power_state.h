...
/**
 * @brief Construct a pm_state_info from 'cpu_idle_states' property at index 'i'
 *
 * @param node_id A node identifier compatible with zephyr,idle-state
 * @param i index of cpu_idle_states prop which type is 'phandles'
 ...
 *			idle-state = "suspend-to-idle";
 *			min-residency-us = <1>;
 *		};
 *
 *		state1: state1 {
 *			compatible = "zephyr,idle-state";
 *			idle-state = "suspend-to-ram";
 *			min-residency-us = <5>;
 *		};
 *	};
 *
...
/**
 * @brief Construct a pm_state enum from 'cpu_idle_states' property at index 'i'
 *
 * @param node_id A node identifier compatible with zephyr,idle-state
 * @param i index of pm_states prop which type is 'phandles'
 * @return pm_state item from 'cpu_idle_states' property at index 'i'
 */
